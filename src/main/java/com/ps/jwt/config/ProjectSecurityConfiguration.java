...
import com.ps.jwt.filter.CsrfCookieFilter;
import com.ps.jwt.filter.JwtTokenGeneratorFilter;
import com.ps.jwt.filter.JwtTokenValidaterFilter;
...
public class ProjectSecurityConfiguration {
    ...
    SecurityFilterChain SpringSecurityCustomFilterChain(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement(sessionManagement -> sessionManagement.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
            ...
            .addFilterBefore(new JwtTokenValidaterFilter(), BasicAuthenticationFilter.class)
            .authorizeHttpRequests(

                requests -> requests
                    // Authority related code changes
                    /*
                     * .requestMatchers("/myAccount").hasAuthority("VIEWACCOUNT") .requestMatchers( "/myBalance").hasAnyAuthority("VIEWACCOUNT","VIEWBALANCE")
                     * .requestMatchers( "/myLoans").hasAuthority("VIEWLOANS") .requestMatchers( "/myCards").hasAuthority("VIEWCARDS")
                     */
